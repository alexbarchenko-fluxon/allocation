// Standalone variant of App: HashRouter instead of BrowserRouter so navigation
// works from a single file:// HTML with no server. Mirrors App.tsx routes exactly.
