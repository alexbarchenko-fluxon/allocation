...
/**
 * Basic tabs with content sections.
 */
      ...
      <TabsContent value="overview" className="space-y-4">
        <div className="text-sm">
          ...
          <p className="text-muted-foreground">
            View a summary of your account activity and recent updates.
          </p>
        </div>
      </TabsContent>
  ...
  render: () => (
    <Tabs defaultValue="tab1" className="w-[400px]">
      <TabsList>
        ...
        <TabsTrigger value="tab2">Also Enabled</TabsTrigger>
        <TabsTrigger value="tab3" disabled>
          Disabled
        </TabsTrigger>
      </TabsList>
      <TabsContent value="tab1">
        <p className="text-sm">Content for first tab.</p>
      </TabsContent>
      <TabsContent value="tab2">
        <p className="text-sm">Content for second tab.</p>
      </TabsContent>
